...
<main class="bg-white h-full">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto ">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Редактировать группу {{ $group->title }} ✨</h1>
        </div>
                ...
                <div>
                    <div class="grid gap-5 md:grid-cols-3">
                            ...
                            <form action="{{ route('admin.group.update', $group->id) }}" method="post">
                                ...
                                <input id="title" class="form-input w-full" name="title" type="text" placeholder="Наименование" value="{{ $group->title }}">

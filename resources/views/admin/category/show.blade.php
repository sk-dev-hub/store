    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Категория ✨</h1>
            </div>
                        ...
                        <form action="{{ route('admin.category.delete', $category->id) }}" class="btn bg-rose-500 hover:bg-rose-600 text-white cursor-pointer" method="post">
                            @csrf
                            @method('delete')
